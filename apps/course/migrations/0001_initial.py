# Generated by Django 2.1.7 on 2019-07-05 13:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_url', models.URLField(help_text='课程封面图片', verbose_name='课程封面图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='逻辑删除')),
                ('name', models.CharField(help_text='课程分类', max_length=100, verbose_name='课程分类')),
            ],
            options={
                'verbose_name': '课程分类',
