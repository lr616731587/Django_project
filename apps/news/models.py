...
"""
文章分类：name, create_time, update_time, is_delete 
文章表: title, digest, content, clicks, image_url, author(一对多), tag(一对多)
文章评论表：content, author(一对多), news()
热门文章表：news(一对一), priority
轮播图：image_url, priority, news(一对一)
"""
